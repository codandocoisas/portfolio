  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border-2 border-gray-100 object-cover w-24 h-24 
        md:w-28 md:h-28 xl:w-32 xl:h-32 
      ...
      >
        <div className="flex items-center justify-center h-full">
          <p className="text-3xl font-bold text-black opacity-100 ml-2">
            {skill.progress}%
          </p>
        </div>
      </div>
