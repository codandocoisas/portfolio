  ...
  return (
    ...
    >
      ...
      <div className="px-0 md:px-10">
        ...
        <ul
          className="px-4 py-2 w-full list-disc space-y-4 ml-5 text-lg h-56 overflow-y-scroll scrollbar-thin 
        scrollbar-track-gray-400/20 scrollbar-thumb-[#D90724]/80"
        >
